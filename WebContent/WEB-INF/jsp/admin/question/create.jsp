					...
					<div class="panel-body">
						<form id="form" role="form">
							<div class="form-group">
								<label for="title">话题标题</label><input id="title" name="title" class="form-control" placeholder="话题标题" />
							</div>
							...
							<div class="form-group">
								...
								<input type="hidden" name="imgupid" id="imgupid"> <img id="img-pic" src="" width="290" height="240" style="margin-top: 10px;">
							</div>
							...
							<div class="form-group">
								...
								<input type="hidden" name="mp4name" id="mp4name"><input type="hidden" name="mp4upid" id="mp4upid">
							</div>

							<label id="mp4_upload_success">&nbsp;</label>
						</form>
					</div>
				</div>
