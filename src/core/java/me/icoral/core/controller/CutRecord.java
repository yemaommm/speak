...
public class CutRecord {
	...
	public static boolean cut(String sourcefile, String targetfile, int start, int end) {
		try {
			// if (!sourcefile.toLowerCase().endsWith(".wav") ||
			// !targetfile.toLowerCase().endsWith(".wav")) {
			// return false;
			// }
	...
	public static void main(String[] args) {
		System.out.println(cut("/home/hei/upload/record/70A1C15D-8EEE-BB53-8AD5-F00CC87648F9.wav", "/home/hei/upload/record/111-cut_0_10.wav", 6, 16));
	}
