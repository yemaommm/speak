...
@Controller
public class VerifiCodeController extends HttpServlet {

	private static final long serialVersionUID = 1L;

	public VerifiCodeController() {
		super();
	}
	...
	@RequestMapping(value = "/verifiCode.do", method = RequestMethod.GET)
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (int i = 0; i < 4; i++) {
			...
			g.drawString(String.valueOf(ctmp), 20 * i + 15, 20);
		}
	...
	@RequestMapping(value = "/verifiyCheck.do", method = RequestMethod.GET)
	public void verifiyCheck(String code, HttpServletRequest request, HttpServletResponse response) {
		String result;
		String jsonResult;
		String currentCode = (String) request.getSession().getAttribute("randCheckCode");
